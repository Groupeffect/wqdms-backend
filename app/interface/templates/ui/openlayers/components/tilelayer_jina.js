function addGeoJSONTileWithEditor(map, geojsonData) {
  ...
  const draw = new ol.interaction.Draw({
    source: vectorSource,
    type: {% if ctx.draw_type %}'{{ ctx.draw_type }}'{% else %}draw_type || 'Polygon' {% endif %}  // Change to 'Point', 'LineString', etc. as needed
  });
