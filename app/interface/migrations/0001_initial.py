    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('view', models.CharField(blank=True, help_text="template path or string if 'render_sting' includes key 'view'", max_length=2000, null=True)),
                ('template', models.CharField(blank=True, help_text="template path or string if 'render_sting' includes key 'template'", max_length=2000, null=True)),
                ('navbar', models.CharField(blank=True, help_text="template path or string if 'render_sting' includes key 'navbar'", max_length=2000, null=True)),
                ('header', models.CharField(blank=True, help_text="template path or string if 'render_sting' includes key 'header'", max_length=2000, null=True)),
                ('footer', models.CharField(blank=True, help_text="template path or string if 'render_sting' includes key 'footer'", max_length=2000, null=True)),
                ('vueApp', models.CharField(blank=True, help_text="template path or string if 'render_sting' includes key 'vueApp'", max_length=2000, null=True)),
                ('vueData', models.CharField(blank=True, help_text="template path or string if 'render_sting' includes key 'vueData'", max_length=2000, null=True)),
                ('vueComputed', models.CharField(blank=True, help_text="template path or string if 'render_sting' includes key 'vueComputed'", max_length=2000, null=True)),
                ('vueMounted', models.CharField(blank=True, help_text="template path or string if 'render_sting' includes key 'vueMounted'", max_length=2000, null=True)),
                ('vueCreated', models.CharField(blank=True, help_text="template path or string if 'render_sting' includes key 'vueCreated'", max_length=2000, null=True)),
                ('vueMethods', models.CharField(blank=True, help_text="template path or string if 'render_sting' includes key 'vueMethods'", max_length=2000, null=True)),
                ('vueTop', models.CharField(blank=True, help_text="template path or string if 'render_sting' includes key 'vueTop'", max_length=2000, null=True)),
                ('vueBottom', models.CharField(blank=True, help_text="template path or string if 'render_sting' includes key 'vueBottom'", max_length=2000, null=True)),
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
