    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity', models.ForeignKey(blank=True, help_text='Model name', limit_choices_to=models.Q(models.Q(('app_label', 'sensorthings'), ('model', 'feature')), models.Q(('app_label', 'sensorthings'), ('model', 'location')), models.Q(('app_label', 'waterquality'), ('model', 'waterbody')), models.Q(('app_label', 'waterquality'), ('model', 'Sample')), models.Q(('app_label', 'interface'), ('model', 'Geometry')), _connector='OR'), null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='contenttypes.contenttype')),
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.CharField(blank=True, choices=[('ui/app/templates/Map.html', 'ui/app/templates/Map.html'), ('ui/app/templates/openLayers.html', 'ui/app/templates/openLayers.html'), ('ui/app/templates/MapOriginal.html', 'ui/app/templates/MapOriginal.html'), ('ui/app/templates/foliumMap.html', 'ui/app/templates/foliumMap.html'), ('ui/app/templates/vueMap.html', 'ui/app/templates/vueMap.html'), ('ui/app/templates/basic.html', 'ui/app/templates/basic.html'), ('ui/app/templates/MainMap.html', 'ui/app/templates/MainMap.html'), ('ui/app/templates/htmx.html', 'ui/app/templates/htmx.html'), ('ui/app/templates/generic.html', 'ui/app/templates/generic.html'), ('ui/app/templates/openLayersSlim.html', 'ui/app/templates/openLayersSlim.html'), ('ui/app/templates/vue.html', 'ui/app/templates/vue.html')], help_text='template path of e.g. index.html that will be loaded first', max_length=2000, null=True)),
                ...
                ('css', models.CharField(blank=True, choices=[('ui/app/css/index.css', 'ui/app/css/index.css'), ('ui/app/css/base.css', 'ui/app/css/base.css')], help_text='template path of e.g. index.css', max_length=2000, null=True)),
                ...
                ('vueData', models.CharField(blank=True, choices=[('ui/app/data/user.js.vue', 'ui/app/data/user.js.vue'), ('ui/app/data/geojson_layers.leaflet.js', 'ui/app/data/geojson_layers.leaflet.js')], help_text="template path or string if 'render_sting' includes key 'vueData'", max_length=2000, null=True)),
