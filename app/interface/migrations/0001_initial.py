    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('navbar', models.CharField(blank=True, choices=[('ui/app/navbars/navbar.html', 'ui/app/navbars/navbar.html')], help_text="template path or string if 'render_sting' includes key 'navbar'", max_length=2000, null=True)),
